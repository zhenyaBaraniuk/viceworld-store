    ...
    return (
        <aside className="filters">
            <div className="space-y-12">
                ...
                <div>
                    <h3 className="filters__title text-outline">
                        Category
                    </h3>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        <button
                            className="filters__size-btn border border-outline-variant hover:border-on-surface transition-all">
                            XS
                        </button>
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <input className="filters__price-range accent-primary bg-outline-variant"
                               max="1200" min="50" type="range" value="495"/>
                ...
                <div>
                    ...
                    <div className="filters__colors">
                        <button
                            className="w-5 h-5 bg-black border border-outline-variant ring-1 ring-offset-2 ring-on-surface"></button>
