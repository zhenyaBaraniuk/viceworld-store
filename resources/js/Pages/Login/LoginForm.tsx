...
export default function LoginForm() {
    ...
    return (
        <div className="w-full max-w-md bg-white border border-transparent shadow-none p-8 md:p-12 relative z-10">
            <div className="mb-10">
                <h1 className="text-4xl font-black uppercase tracking-[-0.03em] leading-none mb-2">Login</h1>
                <p className="text-neutral-500 text-sm tracking-tight">Access your V!ceWorld account.</p>
            </div>

            <form onSubmit={login} className="space-y-8">
                <div className="group">
                    <label
                        className="block font-headline text-xs font-bold uppercase tracking-widest mb-2 group-focus-within:text-primary transition-colors">
                        Email Address
                    </label>
                    <input
                        type="email"
                ...
                <div className="group">
                    <label
                        className="block font-headline text-xs font-bold uppercase tracking-widest mb-2 group-focus-within:text-primary transition-colors">Password</label>
                    <input
                        type="password"
                        placeholder="••••••••"
                        value={data.password}
                ...
                <div
                    className="flex items-center justify-between text-xs font-bold uppercase tracking-tight font-headline">
                ...
                >
                    ...
                    <span className="font-headline font-black text-xl tracking-tighter uppercase">Login</span>
                    <ArrowRight
