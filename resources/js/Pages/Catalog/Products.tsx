...
export default function Products({ products, filters }: Props) {
    ...
    return (
        <section className="products">
            <div
                className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-16 gap-x-8 transition-opacity duration-300 ${
                ...
                {products.data.map((product) => (
                    ...
                    >
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="product-card__price font-headline">
                                ${product.price}
                            </p>
                        </div>
                    </Link>
