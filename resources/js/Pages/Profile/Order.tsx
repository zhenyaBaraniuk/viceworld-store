...
export default function Order() {
    return (
        <section className="md:col-span-9">
                    ...
                    <table className="order__table">
                        <thead>
                            <tr className="bg-surface-container-high">
                                <th className="order__table-tr text-header">ORDER</th>
                                <th className="order__table-tr text-header">Date</th>
                                <th className="order__table-tr text-header">Status</th>
                        ...
                        <tr className="hover:bg-white transition-colors group">
                            ...
                            <td className="p-6 text-right font-bold text-lg">$442.00</td>

                            <td className="p-6 text-right">
                                <button
                                    className="text-primary font-black uppercase text-xs tracking-widest border-b-2 border-transparent hover:border-primary transition-all">
                                    View
                                </button>
                            </td>
                        </tr>
                        ...
                        <tr className="hover:bg-white transition-colors group">
                            <td className="p-6">
                                <div className="order__table-body">
                                    <div className="order__table-payload bg-neutral-200">
                                        ...
                                        <span
                                            className="order__table-badge bg-neutral-900 text-white px-1">
                                            +1
                                        </span>
                                    </div>
                                    <span className="order__table-title font-mono text-neutral-400">
                            ...
                            <td className="p-6">
                              <span
                                  className="order__table-status bg-neutral-900  text-white"
                              >Shipped</span>
                            </td>

                            <td className="order__table-total">$1,205.50</td>

                            <td className="p-6 text-right">
                                <button
                                    className="order__table-view text-primary border-b-2 border-transparent hover:border-primary transition-all">
                                    View
                                </button>
                            </td>
                        </tr>
                        ...
                        <tr className="hover:bg-white transition-colors group">
                            ...
                            <td className="p-6">
                              <span
                                  className="order__table-status bg-neutral-300 text-neutral-800"
                              >Pending</span>
                            </td>
                        ...
                        <tr className="hover:bg-white transition-colors group">
                            ...
                            <td className="p-6">
                              <span
                                  className="order__table-status bg-primary text-white"
                              >Delivered</span>
                            </td>
            ...
            <div
                className="mt-12 p-8 border-t-[4px] border-primary bg-surface-container-high flex items-center space-x-6">
                ...
                <div>
                    <p className="text-header font-black text-xl">Track Your Shipments</p>
                    <p className="text-sm text-neutral-600 font-body">
                        Real-time GPS tracking is available for all premium members on
                        orders over $500.
                    </p>
                </div>
            </div>
