        ...
        <>
            <div className="success max-w-4xl">
                ...
                <div className="success__text">
                    <span
                        className="success__text-status font-headline text-primary-container">
                        Order Status: Paid
                    </span>

                    <h1 className="success__text-confirm font-headline text-on-surface">
                        CONFIRMED<br/>&amp; SHIPPED
                    </h1>
                </div>
                ...
                <div className="success__delivery bg-on-surface border-on-surface">
                    <div className="bg-surface p-10 text-left">
                        ...
                        <p className="success__delivery-text font-body text-on-surface-variant">
                            Tracking documentation dispatched to registered electronic mail address.
                        </p>
                    </div>
                    ...
                    <div className="bg-surface p-10 text-left">
                        ...
                        <p className="success__delivery-data font-headline text-on-surface leading-tight">
                            122 Architecture St.<br/>Berlin, DE 10115
                        </p>
                    </div>
                </div>

                <div className="success__buttons">
                    <a className="success__buttons-shop bg-on-surface text-white font-headline hover:bg-primary-container transition-colors duration-150"
                       href="#">
                        Shop Again
                    ...
                    <a className="success__buttons-track border-2 bg-transparent border-on-surface text-on-surface font-headline hover:bg-on-surface hover:text-white transition-colors duration-150"
                       href="#">
                        Track Parcel
                    </a>
                </div>
