    ...
    return (
        <main className="page">
            ...
            <div className="content">
                ...
                <button
                    className="bg-primary hover:bg-[#0050cb] text-white font-headline font-bold text-sm md:text-base px-10 py-5 transition-all duration-200 active:scale-95 tracking-wider">
                    TRY AGAIN
                </button>
            </div>
