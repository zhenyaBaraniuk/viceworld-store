        ...
        <main className="page">
            ...
            <div className="content">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                    <button className="bg-primary text-white px-10 py-5 font-headline font-bold tracking-tight text-lg active:scale-95 transition-transform">
                        GO HOME
                    </button>

                    <button className="bg-transparent border-2 border-white text-white px-10 py-5 font-headline font-bold tracking-tight text-lg active:scale-95 transition-transform">
                        VIEW CATALOG
                    </button>
                </div>
            </div>
            ...
            <div className="error-code">
                <span className="font-headline font-light text-sm tracking-widest transform rotate-90 origin-bottom-right text-white">
